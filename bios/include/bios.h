...
void bios_get_cursor();
void bios_set_video_page();
void bios_write_char_only();
void bios_write_char_attr(uint8_t ch, uint8_t page, uint8_t attr, uint16_t count);
void bios_write_char_tty(uint8_t ch, uint8_t page, uint8_t attr);
void bios_scroll_wnd_up();
...
void bios_get_video_state();
void bios_get_lightpen_pos();
void bios_pixel_read();
void bios_pixel_write();
